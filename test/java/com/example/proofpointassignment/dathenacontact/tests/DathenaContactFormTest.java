...
public class DathenaContactFormTest {
    ...
    public static final String URL = "https://www.proofpoint.com/us/contact";
    public static final String MISSING_REQUIRED_FIELD_ERROR_DEFAULT = "This field is required.";

    public static final String MISSING_REQUIRED_EMAIL = "Must be valid email.\n" +
            "example@yourdomain.com";

    public static final String MISSING_REQUIRED_PHONE = "Must be a phone number.\n" +
            "503-555-1212";
